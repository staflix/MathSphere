...
lvl_1.add(Task(text="27 ÷ 6 = ?", answer="4, остаток 3", choice=['4, остаток 3', '3, остаток 4', '5, остаток 2']))
lvl_1.add(Task(text="39 ÷ 8 = ?", answer="4, остаток 7", choice=['4, остаток 7', '5, остаток 6', '3, остаток 5']))
lvl_1.add(Task(text="52 ÷ 9 = ?", answer="5, остаток 7", choice=['5, остаток 7', '6, остаток 5', '4, остаток 8']))
