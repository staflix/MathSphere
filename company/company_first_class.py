...
lvl_8.add(Task(text='Кого он встретил первым?', choice=['Лису', 'Бабушку с дедушкой', 'Волка', "Зайца"],
...
lvl_8.add(Task(text='Что он сделал потом?', choice=['Поел', 'Проснулся', 'Сделал зарядку', "Пошёл в школу"],
               answer='Сделал зарядку', image='pic/13.jpg'))
lvl_8.add(
    Task(text='Какое было его последнее действие?', choice=['Поесть', 'Проснуться', 'Сделать зарядку', "Пойти в школу"],
         answer='Пойти в школу', image='pic/13.jpg'))
...
lvl_7.add(Task(text='Кого он встретил первым?', choice=['Лису', 'Бабушку с дедушкой', 'Волка', "Зайца"],
               answer='Бабушку с дедушкой'))
lvl_7.add(
    Task(text='А потом он с кем встретился?', choice=['С лисой', 'С медведем', 'Волка', "Зайца"], answer='С зайцем'))
...
lvl_10.add(Task(text='какой знак нужно поставить?', choice=['<', '>', '='], answer='<', image='pic/39.jpg'))
lvl_10.add(Task(text='какой знак нужно поставить?', choice=['<', '>', '='], answer='>', image='pic/36.jpg'))
lvl_10.add(Task(text='как называется эта фигура?', choice=['восьмиугольник', 'треугольник', 'квадрат'],
                answer='восьмиугольник', image='pic/40.jpg'))
