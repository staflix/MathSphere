...
lvl_114 = Level(1, info='это финальный тест', style='final_test', time=40, topic='финал 1 класса')


lvl_114.add(Task(text='А сколько здесь всего яблок?', answer='9', image='pic/1.jpg'))
lvl_114.add(Task(text='Сколько же здесь грибов?', answer='8', image='pic/2.jpg'))
lvl_114.add(Task(text='А здесь сколько девочек?', answer='4', image='pic/3.jpg'))
lvl_114.add(Task(text='А сколько у одной пчелки крылышек?', answer='2', image='pic/4.jpg'))
lvl_114.add(Task(text='Сколько же у них всего крыльев?', answer='12', image='pic/4.jpg'))
lvl_114.add(Task(text='А сколько на этой картинке цветов?', answer='3', image='pic/4.jpg'))
lvl_114.add(Task(text='Каких мишек больше?', choice=['Бурых', 'Белых'], answer='Бурых', image='pic/6.jpg'))
lvl_114.add(Task(text='Чего больше: шляп или конфет?', choice=['Шляп', 'Конфет', "Поровну"], answer='Конфет', image='pic/7.jpg'))
lvl_114.add(Task(text='Чего больше: снежинок или лягушек?', choice=['Лягушек', 'Снежинок', "Поровну"], answer='Поровну', image='pic/7.jpg'))
lvl_114.add(Task(text='Морковки больше, меньше или равно?', choice=['Больше', 'Меньше', 'Равно'], answer='Равно', image='pic/9.jpg'))
lvl_114.add(Task(text='Лука больше, меньше или равно?', choice=['Больше', 'Меньше', 'Равно'], answer='Больше', image='pic/10.jpg'))
lvl_114.add(Task(text='Желудей больше, меньше или равно по сравнению с клубникой?', choice=['Больше', 'Меньше', 'Равно'], answer='Меньше', image='11.jpg'))
lvl_114.add(Task(text='А что выше: светофор или дом?', choice=['Дом', 'Светофор', 'Похожие по размеру'], answer='Дом'))
lvl_114.add(Task(text='Кто умнее: филин или кабан?', choice=['Кабан', 'Филин', 'Похожие по уму'], answer='Филин'))
lvl_114.add(Task(text='Как мальчику дойти до школы?', choice=['Пойти направо', 'Пойти налево', 'Пойти вперёд'], answer='Пойти направо', image='pic/12.jpg'))
lvl_114.add(Task(text='А как дойти до кинотеатра?', choice=['Пойти направо', 'Пойти налево', 'Пойти вперёд'], answer='Пойти налево', image='pic/12.jpg'))
lvl_114.add(Task(text='Сколько цветов справа от мальчика?', answer='2', image='pic/12.jpg'))
lvl_114.add(Task(text='А сколько слева от мальчика?', answer='3', image='pic/12.jpg'))
lvl_114.add(Task(text="На каом месте четвертая по размеру гусиница?", choice=['1', '2', '3', '4', '5'], answer='3', image='pic/21.jpg'))
lvl_114.add(Task(text="Есть ли на картинке ленточки одинаковой длинны", choice=['нет', 'да'], answer='да', image='pic/23.jpg'))
lvl_114.add(Task(text="Все ли линии одиноковые по длинне?", choice=['да', 'нет'], answer='нет', image="pic/25.jpg"))
lvl_114.add(Task(text="Какая палочка между длинной и короткой", choice=['2', '3', '1'], answer='2', image="pic/18.jpg"))
lvl_114.add(Task(text="под каким номером самая кароткая гусеница?", answer='2', image='pic/21.jpg'))
lvl_114.add(Task(text="Есть ли на картинке предметы одиниковой длинны?", choice=['нет', 'да'], answer='да', image="pic/17.jpg"))
lvl_114.add(Task(text='Выберите знак + или -', choice=['+', '-'], answer='+', image='pic/27.jpg'))
lvl_114.add(Task(text='+ или -', choice=['-', '+'], answer='+', image='pic/28.jpg'))
lvl_114.add(Task(text='Выберите знак', choice=['+', '-'], answer='-', image='pic/29.jpg'))
lvl_114.add(Task(text='Ну и последний раз', choice=['+', '-'], answer='+', image='pic/30.jpg'))
lvl_114.add(Task(text='', answer='1', image='pic/33.jpg'))
lvl_114.add(Task(text='Ну и последний раз', answer='5', image='pic/34.jpg'))
lvl_114.add(Task(text='', choice=['<', '>', '='], answer='>', image='pic/37.jpg'))
lvl_114.add(Task(text='', choice=['<', '>', '='], answer='<', image='pic/38.jpg'))
lvl_114.add(Task(text='', choice=['<', '>', '='], answer='<', image='pic/39.jpg'))
lvl_114.add(Task(text='какой знак нужно поставить?', choice=['<', '>', '='], answer='<', image='pic/39.jpg'))
lvl_114.add(Task(text='какой знак нужно поставить?', choice=['<', '>', '='], answer='>', image='pic/36.jpg'))
lvl_114.add(Task(text='какой знак нужно поставить?', choice=['<', '>', '='], answer='>', image='pic/37.jpg'))
lvl_114.add(Task(text='как называется эта фигура?', choice=['восьмиугольник', 'треугольник', 'квадрат'], answer='восьмиугольник', image='pic/40.jpg'))
lvl_114.add(Task(text='как называется красная фигура?', choice=['восьмиугольник', 'треугольник', 'квадрат'], answer='треугольник', image='pic/41.jpg'))
lvl_114.add(Task(text='сколько углов у фигуры под номером 9? ', answer='12', image='pic/42.jpg'))
lvl_114.add(Task(text='сколько фигур с 2 углами?', answer='2', image='pic/41.jpg'))
lvl_114.add(Task(text='под каким номером фигура с 12 углами?', answer='7', image='pic/42.jpg'))
lvl_114.add(Task(text='сколько углов у синей фигуры?', answer='8', image='pic/40.jpg'))
lvl_114.add(Task(text='В коробке было 8 яблок, а потом в нее положили еще 4 яблока. Сколько яблок в коробке всего?', answer='12'))
lvl_114.add(Task(text='У Маши было 6 кукол, потом ее подруга подарила ей еще 5 кукол. Сколько кукол у Маши стало после подарка?', answer='11'))
lvl_114.add(Task(text=' У Маши было 9 конфет, потом она отдала другу 4 конфеты. Сколько конфет осталось у Маши?', answer='5'))
lvl_114.add(Task(text='У кота было 6 мышей, а потом он поймал еще 5 мышей. Сколько мышей у кота всего?', answer='11'))
lvl_114.add(Task(text=' В книге было 6 страниц, а дописали еще 4.', answer='10'))
lvl_114.add(Task(text='На тарелке было 5 печений, а съели еще 3', answer='2'))
lvl_114.add(Task(text='Коля нарисовал 8 солнышек и 4 облака. Потом он добавил еще 3 солнышка. Сколько солнышек у него теперь?', answer='15'))
lvl_114.add(Task(text='У Вики было 7 карандашей, а у Миши было на 2 карандаша больше. Сколько карандашей у Миши?', answer='9'))
lvl_114.add(Task(text='Коля нарисовал 8 солнышек и 4 облака. Потом он добавил еще 3 солнышка. Сколько солнышек у него теперь?', answer='15'))
lvl_114.add(Task(text='У Вики было 7 карандашей, а у Миши было на 2 карандаша больше. Сколько карандашей у Миши?', answer='9'))
lvl_114.add(Task(text='У Пети было 7 зеленых маркеров, а у Кати было 6. Кто из детей получил больше маркеров?', answer='Петя', choice=["Петя", "Катя"]))
lvl_114.add(Task(text='В коробке было 8 красных шариков и 3 синих. Сколько шариков было всего?', answer='11'))
lvl_114.add(Task(text='В школе было 10 учеников, а в детском саду - 6. Сколько детей было всего?', answer='16'))
lvl_114.add(Task(text='В корзине было 11 яблок, а в сумке - 6. Сколько яблок было вместе?', answer='17'))
lvl_114.add(Task(text='У Кати было 9 конфет, а у Пети - 4. Кто из детей получил больше конфет?', answer='Катя', choice=["Катя", "Петя"]))
lvl_114.add(Task(text="3+?=10", answer='7'))
lvl_114.add(Task(text="7+?=10", answer='3'))
lvl_114.add(Task(text='6+3', answer='9'))
lvl_114.add(Task(text='8+2', answer='10'))
lvl_114.add(Task(text="5+?=9", answer='4'))
lvl_114.add(Task(text="?+6=7", answer='6'))
lvl_114.add(Task(text="7+?=10", answer='3'))
lvl_114.add(Task(text="7+?=8", answer='1'))
lvl_114.add(Task(text="5+?=8", answer='3'))
lvl_114.add(Task(text="?+6=6", answer='0'))
lvl_114.add(Task(text="7+?=9", answer='2'))
lvl_114.add(Task(text="5+?=6", answer='1'))
lvl_114.add(Task(text="8-1=?", answer='7'))
lvl_114.add(Task(text="8-4=?", answer='4'))
lvl_114.add(Task(text='5-1=?', answer="4"))
lvl_114.add(Task(text='5-5=?', answer="0"))
lvl_114.add(Task(text='5-?=5', answer="0"))
lvl_114.add(Task(text='5-?=3', answer="2"))
lvl_114.add(Task(text='6-3=?', answer="3"))
lvl_114.add(Task(text='5-3=?', answer="2"))
lvl_114.add(Task(text='запиши пропушеные цифры', image="pic/45.jpg", answer="24579"))
lvl_114.add(Task(text='найди соседние цифры', answer="1113", image="pic/46.jpg"))
lvl_114.add(Task(text='найди соседий', image="pic/47.jpg", answer="1618"))
lvl_114.add(Task(text='найди соседий', image="pic/48.jpg", answer="1517"))
lvl_114.add(Task(text='выполни задания на картинке', image="pic/44.jpg", answer="67891011121314151617"))
lvl_114.add(Task(text='Сколько дециметров в 1 метре?', answer="10"))
lvl_114.add(Task(text='Сколько дециметров в 2 метрах?', answer="20"))
lvl_114.add(Task(text='Расставь числа в порядке возрастания: 15 дм, 7 дм, 12 дм.', answer="71215"))
lvl_114.add(Task(text='Сколько дециметров в 1 метре?', answer="10"))
lvl_114.add(Task(text='А сколько дециметров в 4 метрах?', answer="40"))
lvl_114.add(Task(text='В классе лежит линейка длиной 10 дм. Сколько дециметров на ней?', answer="10"))
lvl_114.add(Task(text='На листе бумаги отмечено расстояние 5 дм. Если это расстояние разделить на 5 частей, сколько дециметров будет в каждой части?', answer="1"))
lvl_114.add(Task(text='Расставь числа в порядке возрастания: 15 дм, 7 дм, 12 дм.', answer="71215"))
lvl_114.add(Task(text="3+?=13", answer='10'))
lvl_114.add(Task(text="7+?=15", answer='8'))
lvl_114.add(Task(text='6+5', answer='11'))
lvl_114.add(Task(text='6+6', answer='12'))
lvl_114.add(Task(text="5+?=15", answer='10'))
lvl_114.add(Task(text="?+2=14", answer='12'))
lvl_114.add(Task(text="7+?=18", answer='11'))
lvl_114.add(Task(text="5+?=12", answer='7'))
lvl_114.add(Task(text="?+6=17", answer='11'))
lvl_114.add(Task(text="7+?=12", answer='5'))
lvl_114.add(Task(text="5+?=12", answer='7'))
lvl_114.add(Task(text="?+6=13", answer='7'))
lvl_114.add(Task(text="7+?=19", answer='12'))
lvl_114.add(Task(text='5-10=?', answer="-5"))
lvl_114.add(Task(text='5-11=?', answer="-6"))
lvl_114.add(Task(text="-1-2=?", answer='-3'))
lvl_114.add(Task(text="8-8=?", answer='0'))
lvl_114.add(Task(text='5-?=19', answer="14"))
lvl_114.add(Task(text='6-3=?', answer="3"))
lvl_114.add(Task(text='5-6=?', answer="-1"))
lvl_114.add(Task(text='5-?=-7', answer="2"))
lvl_114.add(Task(text='5-?=-10', answer="15"))
lvl_114.add(Task(text='5-?=-5', answer="10"))
